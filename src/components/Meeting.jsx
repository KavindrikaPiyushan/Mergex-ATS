...
export default function Meeting() {
  return (
    <div>
      <div className="meeting_container flex items-center justify-around 900px:justify-between bg-[rgba(255,_255,_255,_0.04)] h-[40px] border-[1px] border-[solid] border-[rgba(255,255,255,0.04)]">
