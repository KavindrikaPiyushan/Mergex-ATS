...
export default function CardEsm(props) {
  return (
    ...
    <div className="txt mx-[auto] my-[0] text-center">
        <p className='text-[#ffffff] 320px:text-[0.2rem]  450px:text-[0.4rem] sm:text-[0.6rem]   900px:text-[0.8rem]  1010px:text-[11px] sm:mt-[20px] md:mt-[0px] md:translate-y-[0.6rem] lg:translate-y-[1rem] 2xl:translate-y-[-0.4rem]  translate-x-0'>{props.name}</p>
