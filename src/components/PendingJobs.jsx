...
export default function PendingJobs(props) {
  ...
  return (
    <div>
      <div className='bg-[linear-gradient(180deg,_rgba(98,_92,_88,_0.136)_0%,_rgba(48,_48,_48,_0.2)_100%)] p-[10px] rounded-[25px] mb-[10px] 320px:text-[0.5rem]  450px:text-[0.8rem] sm:text-[0.9rem]   900px:text-[1.1rem]  1010px:text-[1.2rem] '>
        <div className='JobPostCover flex flex-row flex flex-row items-center justify-around mx-[25px] my-0 px-[25px] py-0'>
          ...
          <div className='DecisionCover flex flex-row items-center esm:gap-0.5 350px:gap-2 500px:gap-2 sm:gap-4 md:gap-7 1010px:gap-16'>
            <MdRemoveRedEye onClick={handleOpenPopup} className='esm:w-[30px] esm:h-[30px] 350px:w-[35px] 350px:w-[35px] 500px:w-[40px] 500px:h-[40px]  sm:w-[45px] sm:h-[45px] md:w-[55px] md:h-[55px] 1010px:w-[60px] 1010px:h-[60px] 1300px:w-[65px] 1300px:h-[65px] xl:w-[70px] xl:h-[70px] text-[rgba(255,_255,_255,_0.25)] cursor-pointer' />
      ...
      <div className={`${isPopupOpen ? 'block' : 'hidden'} fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50`}></div>
      {isPopupOpen && (
        <div>
          ...
          <div className='popup p-[30px] bg-[rgba(43,43,43)] border-[1px] border-[solid] border-[#EA7122] w-[800px] rounded-[30px] mt-[20px] mb-[20px] z-50 fixed top-1/2 left-2/4 -translate-x-1/2 -translate-y-1/2'>
            <div className='absolute w-full'>
              <IoClose onClick={handleClosePopup} className='relative top-[0px] left-[720px] cursor-pointer' />
            </div>
            ...
            <p className='text-[rgba(255,255,255)] text-center'>A software engineer is a professional who designs, develops, and maintains software applications, systems, and programs. They possess expertise in programming languages, algorithms, and problem-solving techniques to create efficient and functional software solutions. Software engineers collaborate with cross-functional teams, including designers and product managers, to understand requirements and deliver high-quality software products. They are adept at debugging and troubleshooting issues, ensuring the smooth functioning of the software throughout its lifecycle. Continuous learning and staying updated with emerging technologies are integral aspects of a software engineer's role to adapt to the dynamic and evolving landscape of the tech industry.</p>
